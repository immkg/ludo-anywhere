      ...
      <div className="flex flex-col gap-6 xl:flex-row xl:items-start xl:gap-10">
        <div className="flex min-w-0 flex-1 flex-col gap-5">
          <div className="grid grid-cols-2 gap-3">
            <Link
              href="/create"
              className="flex min-h-[128px] flex-col justify-between rounded-3xl border-2 border-accent/30 bg-accent/10 p-4 transition active:scale-[0.98] sm:min-h-[150px] sm:p-5"
            >
            ...
            <Link
              ...
              style={{ borderColor: `${BLUE}4d`, backgroundColor: `${BLUE}14` }}
            >
              <div className="min-w-0">
