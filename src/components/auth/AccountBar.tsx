    ...
    <div className="flex items-center gap-3 rounded-2xl border border-line bg-surface p-3">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="flex gap-3">
          <Link href="/profiles" className="text-xs text-ink-muted underline">
            Manage players
          </Link>
          <Link href="/history" className="text-xs text-ink-muted underline">
            History
          </Link>
          <Link href="/leaderboard" className="text-xs text-ink-muted underline">
            Leaderboard
          </Link>
        </div>
      </div>
